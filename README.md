...
```
3. Полученный токен в BotFather вставить в созданный файл .env. На удаленном сервере это можно сделать с помощью редакторов nano или vim.
...
4. Для запуска контейнера в фоновом режиме используйте команду
...
5. Для автоматизированной сборки нескольких контейнеров воспользуйтесь docker-compose
...
6. Если вы хотите остановить контейнер docker
